...
public enum ErrorCode {
    ...
    SELF_MUTE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, 4012, "자기 자신은 관심없음 설정할 수 없습니다."),
    SELF_UNMUTE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, 4013, "자기 자신에 대한 관심없음은 해제할 수 없습니다."),
    ...
    NOT_MUTED(HttpStatus.NOT_FOUND, 4049, "관심없음 상태가 아닙니다."),
